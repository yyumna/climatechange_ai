...
<summary>
 ...
 This paper presents the Future Arctic initiative, a multi-disciplinary training network where machine learning researchers and ecologists cooperatively study both long- and short-term responses to future climate in Iceland.</details>
...
<summary>
 ...
 Carbon dioxide (CO2) is the leading GHG due to the heavy reliance on fossil fuels. South Africa, whose economy predominantly depends on coal for energy production, is the largest emitter of CO2 in Sub-saharan Africa. As such, there is an urgent need to mitigate CO2 emissions in South Africa and carbon capture and storage (CCS) is amongst the possible options to reduce CO2 emissions. Amongst the promising CCS techniques in use are absorption and adsorption (Davidson 2010). Absorption is a mature technology with about 100% efficiency for CO2 absorption but it is cost-intensive due to large quantities of energy required for desorption, regeneration of the solvent and the environmental unfriendliness of the spent solvent  (Pires et al., 2011). On the other hand, adsorption requires less energy compared to absorption and the materials employed are environmentally friendly. However, new materials displaying a large capacity for CO2 capture are required to make adsorption competitive to absorption. </details>
...
<summary>
 ...
 The arctic has seen significant warming and releases of methane, a potent greenhouse gas have been reported. We aim to apply computer vision to satellite imagery in order to quantify geological methane emissions from the permafrost as well as track and predict their change due to increasing temperatures. </details>
