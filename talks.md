...
---
Works are submitted to one of three tracks: [Research](#Research-Track), [Deployed](#Deployed-Track), or [Ideas](#Ideas-Track). The ID (e.g. R1) indicates the track and number for the poster sessions, and (Spotlight:<time>) if the work will be presented as a spotlight talk at the indicated time. 

## Research Track

### (R1) Policy Search with Non-uniform State Representations for Environmental Sampling
...
### (R2) Modelling GxE with historical weather information improves genomic prediction in new environments
...
### (R3) Machine Learning empowered Occupancy Sensing for Smart Buildings
...
### (R4) Focus and track: pixel-wise spatio-temporal hurricane tracking
...
### (R5) Recovering the parameters underlying the Lorenz-96 chaotic dynamics
...
### (R6) Using Bayesian Optimization to Improve Solar Panel Performance by Developing Antireflective, Superomniphobic Glass
...
### (R7) A quantum mechanical approach for data assimilation in climate dynamics
...
### (R8) Data-driven Chance Constrained Programming based Electric Vehicle Penetration Analysis
...
### (R9) (Spotlight: 4:30PM) Machine Learning for AC Optimal Power Flow
...
### (R10)  (Spotlight: 2:50PM) Targeted Meta-Learning for Critical Incident Detection in Weather Data
...
### (R11) ClimateNet: Bringing the power of Deep Learning to weather and climate sciences via open datasets and architectures
...
### (R12) Improving Subseasonal Forecasting in the Western U.S. with Machine Learning
...
### (R13) Unsupervised Temporal Clustering to Monitor the Performance of Alternative Fueling Infrastructure
...
### (R14) A Flexible Pipeline for Prediction of Tropical Cyclone Paths
...
### (R15) Mapping land use and land cover changes faster and at scale with deep learning on the cloud
...
### (R16) Achieving Conservation of Energy in Neural Network Emulators for Climate Modeling
...
### (R17) The Impact of Feature Causality on Normal Behaviour Models for SCADA-based Wind Turbine Fault Detection
...
### (R18) Predicting CO2 Plume Migration using Deep Neural Networks
...
### (R19) (Spotlight: 4:20PM) Truck Traffic Monitoring with Satellite Images
...
### (R20) (Spotlight: 2:40PM) Evaluating aleatoric and epistemic uncertainties of time series deep learning models for soil moisture predictions
...
### (R21) (Spotlight: 2:30PM) Detecting anthropogenic cloud perturbations with deep learning
...
### (R22) Data-driven surrogate models for climate modeling: application of echo state networks, RNN-LSTM and ANN to the multi-scale Lorenz system as a test case
...
### (R23) Learning Radiative Transfer Models for Climate Change Applications in Imaging Spectroscopy
...
### (R24)  (Spotlight: 4:40PM) Planetary Scale Monitoring of Urban Growth in High Flood Risk Areas
...
### (R25) Efficient Multi-temporal and In-season Crop Mapping with Landsat Analysis Ready Data via Long Short-term Memory Networks
...
### (D1) Autopilot of Cement Plants for Reduction of Fuel Consumption and Emissions
...
### (D2) (Spotlight: 10:10AM) Towards a Sustainable Food Supply Chain Powered by Artificial Intelligence
...
### (D3)  PVNet: A LRCN Architecture for Spatio-Temporal Photovoltaic Power Forecasting from Numerical Weather Prediction
...
### (D4) Finding Ship-tracks Using Satellite Data to Enable Studies of Climate and Trade Related Issues
...
### (D5) Using Smart Meter Data to Forecast Grid Scale Electricity Demand
...
### (D6) (Spotlight: 10:30AM) Deep Learning for Wildlife Conservation and Restoration Efforts
...
### (I1)  (Spotlight: 4:50PM) Reinforcement Learning for Sustainable Agriculture
...
### (I2) (Spotlight: 4:55PM) Stratospheric Aerosol Injection as a Deep Reinforcement Learning Problem
...
### (I3) (Spotlight: 5:00PM) Using Natural Language Processing to Analyze Financial Climate Disclosures
...
### (I4) Machine Learning-based Maintenance for Renewable Energy: The Case of Power Plants in Morocco
...
### (I5) GainForest: Scaling Climate Finance for Forest Conservation using Interpretable Machine Learning on Satellite Imagery
...
### (I6) Machine Intelligence for Floods and the Built Environment Under Climate Change
...
### (I7) Predicting Marine Heatwaves using Global Climate Models with Cluster Based Long Short-Term Memory
...
### (I8) (Spotlight: 5:05PM) ML-driven search for zero-emissions ammonia production materials
...
### (I9) (Spotlight: 5:10PM) Low-carbon urban planning with machine learning
...
### (I10) The Grid Resilience & Intelligence Platform (GRIP)
...
### (I11) Meta-Optimization of Optimal Power Flow
...
### (I12) Learning representations to predict landslide occurrences and detect illegal mining across multiple domains
...
### (I13) Harness the Power of Artificial intelligence and -Omics to Identify Soil Microbial Functions in Climate Change Projection
